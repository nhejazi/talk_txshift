...
\begin{itemize}
  ...
  \item \textit{P3008}: How would COVID-19 disease rate have differed in the
    vaccinated due to HIV-1/AIDS immune system impact?
  \item \textbf{Question}: How can [HIV-1, COVID-19] vaccines be improved by
    the modulation of immunogenic response profiles?
\end{itemize}
\end{center}
...
\vspace*{-0.1cm}
\hspace*{-0.3cm}\includegraphics[scale=0.21]{sve_pseudoneutid50_simplified}
...
\vspace*{-0.1cm}
\hspace*{-0.3cm}\includegraphics[scale=0.21]{sve_pseudoneutid50_immunobridging}
...
\hspace*{-0.5cm}\includegraphics[scale=0.285]{tnd_sve_scatter}
